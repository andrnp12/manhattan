...
<head>
  <title>Sola - Solar Energy HTML Website Template</title>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="container">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          <ul class="info d-flex flex-wrap list-unstyled m-0">
            <li class="location text-white text-capitalize d-flex align-items-center me-4" style="font-size: 12px;">
              <svg class="text-primary me-1" width="15" height="15">
                <use xlink:href="#location"></use>
              </svg>State Road 54 Trinity, Florida
            </li>
            <li class="phone text-white text-capitalize d-flex align-items-center me-4" style="font-size: 12px;">
              <svg class="text-primary me-1" width="15" height="15">
        ...
        <div class="header-bottom offcanvas offcanvas-end" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div class="offcanvas-body align-items-center justify-content-end">
            <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
              ...
              <li class="nav-item px-3">
                <a class="nav-link p-0" href="blog.html">Blog</a>
              </li>
              <li class="nav-item px-3">
              ...
              <li class="nav-item px-3 dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  ...
                  <li class="py-1"><a href="services.html" class="dropdown-item text-uppercase ">Services <span
                        class="badge bg-secondary">Pro</span></a></li>
                  <li class="py-1"><a href="services-single.html" class="dropdown-item text-uppercase ">Service-Single
                      <span class="badge bg-secondary">Pro</span></a></li>
                  <li class="py-1"><a href="project.html" class="dropdown-item text-uppercase ">Project <span
                        class="badge bg-secondary">Pro</span></a></li>
                  <li class="py-1"><a href="project-single.html" class="dropdown-item text-uppercase ">Project-Single
                      <span class="badge bg-secondary">Pro</span></a></li>
              ...
              <li class="nav-item px-3">
                <a class="nav-link p-0 fw-bold text-uppercase"
                  href="https://templatesjungle.gumroad.com/l/sola-solar-energy-bootstrap-html-website-template"
                  target="_blank">Get Pro</a>
              </li>

              <li class="nav-item ps-3 mt-4 mt-lg-0">
                <a href="quote.html" class="btn btn-outline-primary py-2 px-4">Get a quote</a>
              </li>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mt-5 mt-lg-0">
          ...
          <h3 class="display-5 fw-bold mb-3">Among the Top 10 Solar & Renewable Energy Industry</h3>
          ...
          <a class="btn btn-primary mt-4" href="about.html">About Us</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="services" class="padding-medium">
    <div class="container-fluid p-0">
      <h6 class="text-center text-primary">Our Services</h6>
      <h3 class="text-center display-5 fw-bold mb-3">best services from us</h3>
      <div class="row g-0 mt-5">
        <div class="col-md-6 col-lg-3">
          <div class="service-post position-relative bg-primary">
            ...
            <div class="position-absolute bottom-0 p-5">
              <h5 class="text-white">Wind turbines</h5>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="service-post position-relative bg-primary">
            ...
            <div class="position-absolute bottom-0 p-5">
              <h5 class="text-white">Solar power systems</h5>
              <p class="text-white">Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam.</p>
              <a href="services-single.html">
                <h6 class="text-white text-decoration-underline">Read more</h6>
              </a>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="service-post position-relative bg-primary">
            ...
            <div class="position-absolute bottom-0 p-5">
              <h5 class="text-white">Hydropower plants</h5>
              <p class="text-white">Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam.</p>
              <a href="services-single.html">
                <h6 class="text-white text-decoration-underline">Read more</h6>
              </a>
