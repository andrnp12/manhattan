    ...
    <div class="card">
        <div class="card-body">
            <div class="cold-12 d-flex justify-content-between mb-3">
                <h5 class="card-title fw-semibold">LKP</h5>
                <button type="button" class="btn btn-primary" onclick="openModal('rpp')" data-bs-toggle="modal" data-bs-target="#formModal">Tambah LKP</button>
            </div>
            <div class="card">
                <div class="card-body">
