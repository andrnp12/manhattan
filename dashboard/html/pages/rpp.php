    ...
    <div class="card">
        <div class="card-body">
            <div class="cold-12 d-flex justify-content-between mb-3">
                <h5 class="card-title fw-semibold">RPP</h5>
                <button type="button" class="btn btn-primary" onclick="openModal('rpp')" data-bs-toggle="modal" data-bs-target="#formModal">Tambah RPP</button>
            </div>
            <div class="card">
                <div class="card-body">
                                        ...
                                        <?php foreach ($item['topics'] as $topik) : ?>
                                            <?php if (!empty($topik['rpp'])) : ?>
                                                <?php foreach ($topik['rpp'] as $rpp) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="mb-0 fw-normal"><?php echo $rpp['title']; ?></p>
                                                        </td>
                                                        <td>
                                            ...
                                            <?php else : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0 fw-normal text-danger">Belum ada RPP</p>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            <?php endif; ?>
